...
void* safeThread(){
  ...
  ASSERT((kthread_mutex_lock(mutex1) == -1), "kthread_mutex_lock(%d) fail", mutex1);
       7:	a1 f0 2d 00 00       	mov    0x2df0,%eax
      ...
      20:	00 
      21:	c7 44 24 08 31 29 00 	movl   $0x2931,0x8(%esp)
      28:	00 
      29:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
      30:	00 
      31:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      38:	e8 7d 21 00 00       	call   21ba <printf>
      3d:	a1 f0 2d 00 00       	mov    0x2df0,%eax
      42:	89 44 24 08          	mov    %eax,0x8(%esp)
      46:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
      4d:	00 
      4e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      55:	e8 60 21 00 00       	call   21ba <printf>
      5a:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
      61:	00 
  ...
  resource1[0] = kthread_id();
      ...
      78:	a3 a0 2d 00 00       	mov    %eax,0x2da0
  for(i = 1 ;i < 20; i++){
    ...
    resource1[i] = resource1[i-1];
      ...
      a2:	8b 14 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%edx
      a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
      ac:	89 14 85 a0 2d 00 00 	mov    %edx,0x2da0(,%eax,4)
  ...
  ASSERT((resource1[i-1] != kthread_id()), "(resource1[%d] != kthread_id:%d) fail", i, kthread_id());
      ...
      db:	8b 1c 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%ebx
      ...
      f2:	00 
      f3:	c7 44 24 08 31 29 00 	movl   $0x2931,0x8(%esp)
      fa:	00 
      fb:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     102:	00 
     ...
     11f:	c7 44 24 04 b8 25 00 	movl   $0x25b8,0x4(%esp)
     126:	00 
     127:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     12e:	e8 87 20 00 00       	call   21ba <printf>
     133:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     13a:	00 
  ...
  ASSERT((kthread_mutex_unlock(mutex1) == -1), "kthread_mutex_unlock(%d) fail", mutex1);
     14c:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     ...
     165:	00 
     166:	c7 44 24 08 31 29 00 	movl   $0x2931,0x8(%esp)
     16d:	00 
     16e:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     175:	00 
     176:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     17d:	e8 38 20 00 00       	call   21ba <printf>
     182:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     187:	89 44 24 08          	mov    %eax,0x8(%esp)
     18b:	c7 44 24 04 de 25 00 	movl   $0x25de,0x4(%esp)
     192:	00 
     193:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     19a:	e8 1b 20 00 00       	call   21ba <printf>
     19f:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     1a6:	00 
  ...
  ASSERT((kthread_mutex_lock(mutex2) == -1), "kthread_mutex_lock(%d) fail", mutex2);
     1b8:	a1 80 2d 00 00       	mov    0x2d80,%eax
     ...
     1d1:	00 
     1d2:	c7 44 24 08 31 29 00 	movl   $0x2931,0x8(%esp)
     1d9:	00 
     1da:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     1e1:	00 
     1e2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     1e9:	e8 cc 1f 00 00       	call   21ba <printf>
     1ee:	a1 80 2d 00 00       	mov    0x2d80,%eax
     1f3:	89 44 24 08          	mov    %eax,0x8(%esp)
     1f7:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
     1fe:	00 
     1ff:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     206:	e8 af 1f 00 00       	call   21ba <printf>
     20b:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     212:	00 
  ...
  resource2 = resource2 + kthread_id();
     ...
     241:	8b 15 84 2d 00 00    	mov    0x2d84,%edx
     247:	01 d0                	add    %edx,%eax
     249:	a3 84 2d 00 00       	mov    %eax,0x2d84
  ASSERT((kthread_mutex_unlock(mutex2) == -1), "kthread_mutex_unlock(%d) fail", mutex2);
     24e:	a1 80 2d 00 00       	mov    0x2d80,%eax
     ...
     267:	00 
     268:	c7 44 24 08 31 29 00 	movl   $0x2931,0x8(%esp)
     26f:	00 
     270:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     277:	00 
     278:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     27f:	e8 36 1f 00 00       	call   21ba <printf>
     284:	a1 80 2d 00 00       	mov    0x2d80,%eax
     289:	89 44 24 08          	mov    %eax,0x8(%esp)
     28d:	c7 44 24 04 de 25 00 	movl   $0x25de,0x4(%esp)
     294:	00 
     295:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     29c:	e8 19 1f 00 00       	call   21ba <printf>
     2a1:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     2a8:	00 
...
void* unsafeThread(){
  ...
  resource1[0] = kthread_id();
     ...
     2d5:	a3 a0 2d 00 00       	mov    %eax,0x2da0
  for(i = 1 ;i < 20; i++){
    ...
    resource1[i] = resource1[i-1];
     ...
     2ff:	8b 14 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%edx
     306:	8b 45 f4             	mov    -0xc(%ebp),%eax
     309:	89 14 85 a0 2d 00 00 	mov    %edx,0x2da0(,%eax,4)
...
void* unsafeThread(){
  ...
  resource2 = resource2 + resource1[i-1];
     ...
     32d:	8b 14 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%edx
     334:	a1 84 2d 00 00       	mov    0x2d84,%eax
     339:	01 d0                	add    %edx,%eax
     33b:	a3 84 2d 00 00       	mov    %eax,0x2d84
...
void stressTest1(int count){
  ...
  printf(1, "starting %s test\n", __FUNCTION__);
     39e:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     3a5:	00 
     3a6:	c7 44 24 04 fc 25 00 	movl   $0x25fc,0x4(%esp)
     3ad:	00 
  ...
  for (i = 0 ; i < 20; i++)
    ...
    resource1[i] = 0;
     ...
     3c6:	c7 04 85 a0 2d 00 00 	movl   $0x0,0x2da0(,%eax,4)
     3cd:	00 00 00 00 
  int c=0;
  char* stack;
  ...
  for (i = 0 ; i < count; i++){
    ...
    ASSERT((tid[i] <= 0), "kthread_create return with: %d, for index:%d", tid[i], i);
     ...
     4b1:	00 
     4b2:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     4b9:	00 
     4ba:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     4c1:	00 
     ...
     4e2:	c7 44 24 04 24 26 00 	movl   $0x2624,0x4(%esp)
     4e9:	00 
     4ea:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     4f1:	e8 c4 1c 00 00       	call   21ba <printf>
     4f6:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     4fd:	00 
  ...
  for (i = 0 ; i < count; i++){
    ...
    ASSERT((ans != 0), "kthread_join(%d) return with: %d", tid[i], ans)
     ...
     56e:	00 
     56f:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     576:	00 
     577:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     57e:	00 
     ...
     59f:	c7 44 24 04 54 26 00 	movl   $0x2654,0x4(%esp)
     5a6:	00 
     5a7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     5ae:	e8 07 1c 00 00       	call   21ba <printf>
     5b3:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     5ba:	00 
  ...
  ASSERT( (kthread_mutex_dealloc(mutex1) != 0), "dealloc");
     5dc:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     ...
     5f4:	00 
     5f5:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     5fc:	00 
     5fd:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     604:	00 
     605:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     60c:	e8 a9 1b 00 00       	call   21ba <printf>
     611:	c7 44 24 04 75 26 00 	movl   $0x2675,0x4(%esp)
     618:	00 
     619:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     620:	e8 95 1b 00 00       	call   21ba <printf>
     625:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     62c:	00 
  ...
  ASSERT( (kthread_mutex_dealloc(mutex2) != 0), "dealloc");
     63e:	a1 80 2d 00 00       	mov    0x2d80,%eax
     ...
     656:	00 
     657:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     65e:	00 
     65f:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     666:	00 
     667:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     66e:	e8 47 1b 00 00       	call   21ba <printf>
     673:	c7 44 24 04 75 26 00 	movl   $0x2675,0x4(%esp)
     67a:	00 
     67b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     682:	e8 33 1b 00 00       	call   21ba <printf>
     687:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     68e:	00 
  ...
  printf(1, "%s test PASS!\n", __FUNCTION__);
     70b:	c7 44 24 08 3c 29 00 	movl   $0x293c,0x8(%esp)
     712:	00 
     713:	c7 44 24 04 9b 26 00 	movl   $0x269b,0x4(%esp)
     71a:	00 
...
void stressTest2Fail(int count){
  ...
  printf(1, "starting %s test\n", __FUNCTION__);
     77d:	c7 44 24 08 48 29 00 	movl   $0x2948,0x8(%esp)
     784:	00 
     785:	c7 44 24 04 fc 25 00 	movl   $0x25fc,0x4(%esp)
     78c:	00 
  ...
  for (i = 0 ; i < 20; i++)
    ...
    resource1[i] = 0;
     ...
     7a5:	c7 04 85 a0 2d 00 00 	movl   $0x0,0x2da0(,%eax,4)
     7ac:	00 00 00 00 
  int c=0;
  char* stack;
  ...
  for (i = 0 ; i < 20; i++)
    ...
    resource1[i] = 0;
  resource2 = 0;
     7ba:	c7 05 84 2d 00 00 00 	movl   $0x0,0x2d84
     7c1:	00 00 00 
  ...
  for (i = 0 ; i < count; i++){
    ...
    ASSERT((tid[i] <= 0), "kthread_create return with: %d, for index:%d", tid[i], i);
     ...
     841:	00 
     842:	c7 44 24 08 48 29 00 	movl   $0x2948,0x8(%esp)
     849:	00 
     84a:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     851:	00 
     ...
     872:	c7 44 24 04 24 26 00 	movl   $0x2624,0x4(%esp)
     879:	00 
     87a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     881:	e8 34 19 00 00       	call   21ba <printf>
     886:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     88d:	00 
  ...
  for (i = 0 ; i < count; i++){
    ...
    ASSERT((ans != 0), "kthread_join(%d) return with: %d", tid[i], ans)
     ...
     8e8:	00 
     8e9:	c7 44 24 08 48 29 00 	movl   $0x2948,0x8(%esp)
     8f0:	00 
     8f1:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     8f8:	00 
     ...
     919:	c7 44 24 04 54 26 00 	movl   $0x2654,0x4(%esp)
     920:	00 
     921:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     928:	e8 8d 18 00 00       	call   21ba <printf>
     92d:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     934:	00 
  ...
  printf(1, "%s test PASS!\n", __FUNCTION__);
     9c1:	c7 44 24 08 48 29 00 	movl   $0x2948,0x8(%esp)
     9c8:	00 
     9c9:	c7 44 24 04 9b 26 00 	movl   $0x269b,0x4(%esp)
     9d0:	00 
...
void stressTest3toMuchTreads(int count){
  ...
  printf(1, "starting %s test\n", __FUNCTION__);
     a29:	c7 44 24 08 58 29 00 	movl   $0x2958,0x8(%esp)
     a30:	00 
     a31:	c7 44 24 04 fc 25 00 	movl   $0x25fc,0x4(%esp)
     a38:	00 
  ...
  for (i = 0 ; i < count; i++){
    ...
    ASSERT((tid[i] <= 0), "kthread_create return with: %d, for index:%d", tid[i], i);
     ...
     a9d:	00 
     a9e:	c7 44 24 08 58 29 00 	movl   $0x2958,0x8(%esp)
     aa5:	00 
     aa6:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     aad:	00 
     ...
     ace:	c7 44 24 04 24 26 00 	movl   $0x2624,0x4(%esp)
     ad5:	00 
     ad6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     add:	e8 d8 16 00 00       	call   21ba <printf>
     ae2:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     ae9:	00 
  ...
  if(kthread_create(&loopThread, stack+STACK_SIZE, STACK_SIZE) >= 0){
    ...
    printf(1, "%s test FAIL!\n", __FUNCTION__);
     b2f:	c7 44 24 08 58 29 00 	movl   $0x2958,0x8(%esp)
     b36:	00 
     b37:	c7 44 24 04 e4 26 00 	movl   $0x26e4,0x4(%esp)
     b3e:	00 
    ...
    printf(1, "%s test PASS!\n", __FUNCTION__);
     b4d:	c7 44 24 08 58 29 00 	movl   $0x2958,0x8(%esp)
     b54:	00 
     b55:	c7 44 24 04 9b 26 00 	movl   $0x269b,0x4(%esp)
     b5c:	00 
...
void* yieldThread(){
  ...
  /* part one use mutual array of resources */
  ASSERT((kthread_mutex_lock(mutex2) == -1), "kthread_mutex_lock(%d) fail", mutex2);
     b9e:	a1 80 2d 00 00       	mov    0x2d80,%eax
     ...
     bb7:	00 
     bb8:	c7 44 24 08 70 29 00 	movl   $0x2970,0x8(%esp)
     bbf:	00 
     bc0:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     bc7:	00 
     bc8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     bcf:	e8 e6 15 00 00       	call   21ba <printf>
     bd4:	a1 80 2d 00 00       	mov    0x2d80,%eax
     bd9:	89 44 24 08          	mov    %eax,0x8(%esp)
     bdd:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
     be4:	00 
     be5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     bec:	e8 c9 15 00 00       	call   21ba <printf>
     bf1:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     bf8:	00 
  ...
  resource1[0] = kthread_id();
     ...
     c0f:	a3 a0 2d 00 00       	mov    %eax,0x2da0
  for(i = 1 ;i < 20; i++){
    ...
    resource1[i] = resource1[i-1];
     ...
     c39:	8b 14 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%edx
     c40:	8b 45 f4             	mov    -0xc(%ebp),%eax
     c43:	89 14 85 a0 2d 00 00 	mov    %edx,0x2da0(,%eax,4)
  ...
  ASSERT((resource1[i-1] != kthread_id()), "(resource1[%d] != kthread_id:%d) fail", i, kthread_id());
     ...
     c72:	8b 1c 85 a0 2d 00 00 	mov    0x2da0(,%eax,4),%ebx
     ...
     c89:	00 
     c8a:	c7 44 24 08 70 29 00 	movl   $0x2970,0x8(%esp)
     c91:	00 
     c92:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     c99:	00 
     ...
     cb6:	c7 44 24 04 b8 25 00 	movl   $0x25b8,0x4(%esp)
     cbd:	00 
     cbe:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     cc5:	e8 f0 14 00 00       	call   21ba <printf>
     cca:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     cd1:	00 
  ...
  resource2 = resource2 + kthread_id();
     ...
     d00:	8b 15 84 2d 00 00    	mov    0x2d84,%edx
     d06:	01 d0                	add    %edx,%eax
     d08:	a3 84 2d 00 00       	mov    %eax,0x2d84

  // pass the mutex to the next thread
  ASSERT((kthread_mutex_yieldlock(mutex1, mutex2) != 0), "mutex yield");
     d0d:	8b 15 80 2d 00 00    	mov    0x2d80,%edx
     d13:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     ...
     d2f:	00 
     d30:	c7 44 24 08 70 29 00 	movl   $0x2970,0x8(%esp)
     d37:	00 
     d38:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     d47:	e8 6e 14 00 00       	call   21ba <printf>
     d4c:	c7 44 24 04 f3 26 00 	movl   $0x26f3,0x4(%esp)
     d53:	00 
     d54:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     d5b:	e8 5a 14 00 00       	call   21ba <printf>
     d60:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     d67:	00 
...
void* trubleThread(){
  ...
  ASSERT((kthread_mutex_lock(mutex1) == -1), "kthread_mutex_lock(%d) fail", mutex1);
     d8f:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     ...
     da8:	00 
     da9:	c7 44 24 08 7c 29 00 	movl   $0x297c,0x8(%esp)
     db0:	00 
     db1:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     db8:	00 
     db9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     dc0:	e8 f5 13 00 00       	call   21ba <printf>
     dc5:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     dca:	89 44 24 08          	mov    %eax,0x8(%esp)
     dce:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
     dd5:	00 
     dd6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     ddd:	e8 d8 13 00 00       	call   21ba <printf>
     de2:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     de9:	00 
     dea:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     df1:	e8 c4 13 00 00       	call   21ba <printf>
     df6:	e8 f7 11 00 00       	call   1ff2 <exit>
  resource2 = -10;
     dfb:	c7 05 84 2d 00 00 f6 	movl   $0xfffffff6,0x2d84
     e02:	ff ff ff 

  ASSERT((kthread_mutex_unlock(mutex1) == -1), "kthread_mutex_unlock(%d) fail", mutex1);
     e05:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     ...
     e1e:	00 
     e1f:	c7 44 24 08 7c 29 00 	movl   $0x297c,0x8(%esp)
     e26:	00 
     e27:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
     e2e:	00 
     e2f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     e36:	e8 7f 13 00 00       	call   21ba <printf>
     e3b:	a1 f0 2d 00 00       	mov    0x2df0,%eax
     e40:	89 44 24 08          	mov    %eax,0x8(%esp)
     e44:	c7 44 24 04 de 25 00 	movl   $0x25de,0x4(%esp)
     e4b:	00 
     e4c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     e53:	e8 62 13 00 00       	call   21ba <printf>
     e58:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
     e5f:	00 
...
void mutexYieldTest(){
  ...
  printf(1, "starting %s test\n", __FUNCTION__);
     e91:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
     e98:	00 
     e99:	c7 44 24 04 fc 25 00 	movl   $0x25fc,0x4(%esp)
     ea0:	00 
  ...
  for (i = 0 ; i < 20; i++)
    ...
    resource1[i] = 0;
     ...
     eb9:	c7 04 85 a0 2d 00 00 	movl   $0x0,0x2da0(,%eax,4)
     ec0:	00 00 00 00 
  int c=0;
  char* stack;
  ...
  ASSERT((kthread_mutex_lock(mutex1) != 0), "mutex lock");
    1000:	a1 f0 2d 00 00       	mov    0x2df0,%eax
    ...
    1018:	00 
    1019:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    1020:	00 
    1021:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1028:	00 
    1029:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1030:	e8 85 11 00 00       	call   21ba <printf>
    1035:	c7 44 24 04 19 27 00 	movl   $0x2719,0x4(%esp)
    103c:	00 
    103d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1044:	e8 71 11 00 00       	call   21ba <printf>
    1049:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1050:	00 
  ...
  ASSERT((kthread_mutex_lock(mutex2) != 0), "mutex lock");
    1062:	a1 80 2d 00 00       	mov    0x2d80,%eax
    ...
    107a:	00 
    107b:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    1082:	00 
    1083:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    108a:	00 
    108b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1092:	e8 23 11 00 00       	call   21ba <printf>
    1097:	c7 44 24 04 19 27 00 	movl   $0x2719,0x4(%esp)
    109e:	00 
    109f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    10a6:	e8 0f 11 00 00       	call   21ba <printf>
    10ab:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    10b2:	00 
  ...
  ASSERT((kthread_mutex_yieldlock(mutex1, mutex2) != 0), "mutex yield");
    117a:	8b 15 80 2d 00 00    	mov    0x2d80,%edx
    1180:	a1 f0 2d 00 00       	mov    0x2df0,%eax
    ...
    119c:	00 
    119d:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    11a4:	00 
    11a5:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    11ac:	00 
    11ad:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    11b4:	e8 01 10 00 00       	call   21ba <printf>
    11b9:	c7 44 24 04 f3 26 00 	movl   $0x26f3,0x4(%esp)
    11c0:	00 
    11c1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    11c8:	e8 ed 0f 00 00       	call   21ba <printf>
    11cd:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    11d4:	00 
  ...
  for (i = 0 ; i < 10; i++){
    ...
    126b:	00 
    126c:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    1273:	00 
    1274:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    127b:	00 
    ...
    129a:	c7 44 24 04 54 26 00 	movl   $0x2654,0x4(%esp)
    12a1:	00 
    12a2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    12a9:	e8 0c 0f 00 00       	call   21ba <printf>
    12ae:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    12b5:	00 
  ...
  kthread_mutex_lock(mutex1);
    12d5:	a1 f0 2d 00 00       	mov    0x2df0,%eax
  ...
  kthread_mutex_unlock(mutex1);
    134d:	a1 f0 2d 00 00       	mov    0x2df0,%eax
  ...
  ASSERT((kthread_mutex_lock(mutex1) != 0), "mutex lock");
    1365:	a1 f0 2d 00 00       	mov    0x2df0,%eax
  ...
  ASSERT((kthread_mutex_lock(mutex2) != 0), "mutex lock");
    ...
    13df:	00 
    13e0:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    13e7:	00 
    13e8:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    13ef:	00 
    13f0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    13f7:	e8 be 0d 00 00       	call   21ba <printf>
    13fc:	c7 44 24 04 19 27 00 	movl   $0x2719,0x4(%esp)
    1403:	00 
    1404:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    140b:	e8 aa 0d 00 00       	call   21ba <printf>
    1410:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1417:	00 
  ...
  ASSERT((kthread_mutex_unlock(mutex1) != 0), "mutex unlock");
    1429:	a1 f0 2d 00 00       	mov    0x2df0,%eax
    ...
    1441:	00 
    1442:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    1449:	00 
    144a:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1451:	00 
    1452:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1459:	e8 5c 0d 00 00       	call   21ba <printf>
    145e:	c7 44 24 04 61 27 00 	movl   $0x2761,0x4(%esp)
    1465:	00 
    1466:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    146d:	e8 48 0d 00 00       	call   21ba <printf>
    1472:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1479:	00 
  ...
  ASSERT((kthread_mutex_unlock(mutex2) != 0), "mutex unlock");
    148b:	a1 80 2d 00 00       	mov    0x2d80,%eax
    ...
    14a3:	00 
    14a4:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    14ab:	00 
    14ac:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    14b3:	00 
    14b4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    14bb:	e8 fa 0c 00 00       	call   21ba <printf>
    14c0:	c7 44 24 04 61 27 00 	movl   $0x2761,0x4(%esp)
    14c7:	00 
    14c8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    14cf:	e8 e6 0c 00 00       	call   21ba <printf>
    14d4:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    14db:	00 
  ...
  // free the mutexes
  ASSERT( (kthread_mutex_dealloc(mutex1) != 0), "dealloc");
    14ed:	a1 f0 2d 00 00       	mov    0x2df0,%eax
  ...
  ASSERT( (kthread_mutex_dealloc(mutex2) != 0), "dealloc");
    ...
    1567:	00 
    1568:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    156f:	00 
    1570:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1577:	00 
    1578:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    157f:	e8 36 0c 00 00       	call   21ba <printf>
    1584:	c7 44 24 04 75 26 00 	movl   $0x2675,0x4(%esp)
    158b:	00 
    158c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1593:	e8 22 0c 00 00       	call   21ba <printf>
    1598:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    159f:	00 
  ...
  printf(1, "%s test PASS!\n", __FUNCTION__);
    15b1:	c7 44 24 08 89 29 00 	movl   $0x2989,0x8(%esp)
    15b8:	00 
    15b9:	c7 44 24 04 9b 26 00 	movl   $0x269b,0x4(%esp)
    15c0:	00 
...
void senaty(int count){
  ...
  printf(1, "starting %s test\n", __FUNCTION__);
    15d8:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    15df:	00 
    15e0:	c7 44 24 04 fc 25 00 	movl   $0x25fc,0x4(%esp)
    15e7:	00 
  ...
  for(j=0 ; j<2 ; j++){ // run the test twice to check that mutexes can be reused
    ...
    1631:	00 
    1632:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1639:	00 
    163a:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1641:	00 
    ...
    1655:	c7 44 24 04 70 27 00 	movl   $0x2770,0x4(%esp)
    165c:	00 
    165d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1664:	e8 51 0b 00 00       	call   21ba <printf>
    1669:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1670:	00 
    ...
    16a0:	00 
    16a1:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    16a8:	00 
    16a9:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    16b0:	00 
    ...
    16cb:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
    16d2:	00 
    16d3:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    16da:	e8 db 0a 00 00       	call   21ba <printf>
    16df:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    16e6:	00 
    ...
    1716:	00 
    1717:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    171e:	00 
    171f:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1726:	00 
    ...
    1741:	c7 44 24 04 de 25 00 	movl   $0x25de,0x4(%esp)
    1748:	00 
    1749:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1750:	e8 65 0a 00 00       	call   21ba <printf>
    1755:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    175c:	00 
    ...
    178c:	00 
    178d:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1794:	00 
    1795:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    179c:	00 
    ...
    17b7:	c7 44 24 04 90 27 00 	movl   $0x2790,0x4(%esp)
    17be:	00 
    17bf:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    17c6:	e8 ef 09 00 00       	call   21ba <printf>
    17cb:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    17d2:	00 
  ...
  for(j=0 ; j<2 ; j++){ // run the test twice to check that mutexes can be reused
    ...
    181b:	00 
    181c:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1823:	00 
    1824:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    182b:	00 
    ...
    1846:	c7 44 24 04 99 25 00 	movl   $0x2599,0x4(%esp)
    184d:	00 
    184e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1855:	e8 60 09 00 00       	call   21ba <printf>
    185a:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1861:	00 
    ...
    18ad:	00 
    18ae:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    18b5:	00 
    18b6:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    18bd:	00 
    ...
    18d8:	c7 44 24 04 de 25 00 	movl   $0x25de,0x4(%esp)
    18df:	00 
    18e0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    18e7:	e8 ce 08 00 00       	call   21ba <printf>
    18ec:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    18f3:	00 
    ...
    1923:	00 
    1924:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    192b:	00 
    192c:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1933:	00 
    ...
    194e:	c7 44 24 04 90 27 00 	movl   $0x2790,0x4(%esp)
    1955:	00 
    1956:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    195d:	e8 58 08 00 00       	call   21ba <printf>
    1962:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1969:	00 
    ...
    19b5:	00 
    19b6:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    19bd:	00 
    19be:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    19c5:	00 
    ...
    19e0:	c7 44 24 04 c8 27 00 	movl   $0x27c8,0x4(%esp)
    19e7:	00 
    19e8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    19ef:	e8 c6 07 00 00       	call   21ba <printf>
    19f4:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    19fb:	00 
    ...
    1a2b:	00 
    1a2c:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1a33:	00 
    1a34:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1a3b:	00 
    ...
    1a56:	c7 44 24 04 e8 27 00 	movl   $0x27e8,0x4(%esp)
    1a5d:	00 
    1a5e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1a65:	e8 50 07 00 00       	call   21ba <printf>
    1a6a:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1a71:	00 
    ...
    1aa1:	00 
    1aa2:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1aa9:	00 
    1aaa:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1ab1:	00 
    ...
    1acc:	c7 44 24 04 24 28 00 	movl   $0x2824,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1adb:	e8 da 06 00 00       	call   21ba <printf>
    1ae0:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1ae7:	00 
    ...
    1b17:	00 
    1b18:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1b1f:	00 
    1b20:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1b27:	00 
    ...
    1b42:	c7 44 24 04 58 28 00 	movl   $0x2858,0x4(%esp)
    1b49:	00 
    1b4a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1b51:	e8 64 06 00 00       	call   21ba <printf>
    1b56:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1b5d:	00 
...
void senaty(int count){
  ...
  for (i=0 ; i<MAX_MUTEXES ; i++){
    ...
    1bbe:	00 
    1bbf:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1bc6:	00 
    1bc7:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1bce:	00 
    ...
    1bea:	c7 44 24 04 8c 28 00 	movl   $0x288c,0x4(%esp)
    1bf1:	00 
    1bf2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1bf9:	e8 bc 05 00 00       	call   21ba <printf>
    1bfe:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1c05:	00 
  ...
  ASSERT((kthread_mutex_alloc() != -1), "limit test didn't fail as expected create %d mutexes instad of %d", i+1, MAX_MUTEXES);
    ...
    1c36:	00 
    1c37:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1c3e:	00 
    1c3f:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1c46:	00 
    ...
    1c65:	c7 44 24 04 c8 28 00 	movl   $0x28c8,0x4(%esp)
    1c6c:	00 
    1c6d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1c74:	e8 41 05 00 00       	call   21ba <printf>
    1c79:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1c80:	00 
  ...
  for (i=0 ; i<MAX_MUTEXES ; i++){
    ...
    1cbc:	00 
    1cbd:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1cc4:	00 
    1cc5:	c7 44 24 04 88 25 00 	movl   $0x2588,0x4(%esp)
    1ccc:	00 
    ...
    1cee:	c7 44 24 04 0c 29 00 	movl   $0x290c,0x4(%esp)
    1cf5:	00 
    1cf6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1cfd:	e8 b8 04 00 00       	call   21ba <printf>
    1d02:	c7 44 24 04 b5 25 00 	movl   $0x25b5,0x4(%esp)
    1d09:	00 
  ...
  printf(1, "%s test PASS!\n", __FUNCTION__);
    1d29:	c7 44 24 08 98 29 00 	movl   $0x2998,0x8(%esp)
    1d30:	00 
    1d31:	c7 44 24 04 9b 26 00 	movl   $0x269b,0x4(%esp)
    1d38:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    2153:	0f b6 80 4c 2d 00 00 	movzbl 0x2d4c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    22b0:	75 09                	jne    22bb <printf+0x101>
          s = "(null)";
    22b2:	c7 45 f4 9f 29 00 00 	movl   $0x299f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    237c:	a1 68 2d 00 00       	mov    0x2d68,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    2447:	a3 68 2d 00 00       	mov    %eax,0x2d68
}
    244c:	c9                   	leave  
    244d:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    249f:	a1 68 2d 00 00       	mov    0x2d68,%eax
}
    24a4:	c9                   	leave  
    24a5:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    24bb:	a1 68 2d 00 00       	mov    0x2d68,%eax
    24c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    24c3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    24c7:	75 23                	jne    24ec <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    24c9:	c7 45 f0 60 2d 00 00 	movl   $0x2d60,-0x10(%ebp)
    24d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    24d3:	a3 68 2d 00 00       	mov    %eax,0x2d68
    24d8:	a1 68 2d 00 00       	mov    0x2d68,%eax
    24dd:	a3 60 2d 00 00       	mov    %eax,0x2d60
    base.s.size = 0;
    24e2:	c7 05 64 2d 00 00 00 	movl   $0x0,0x2d64
    24e9:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    253f:	a3 68 2d 00 00       	mov    %eax,0x2d68
      return (void*)(p + 1);
    ...
    if(p == freep)
    254c:	a1 68 2d 00 00       	mov    0x2d68,%eax
