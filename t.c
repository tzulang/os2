...
//
//
//	printf(1,"thread %d is alive \n ",kthread_id());
//
//	int i;
//	for ( i=1; i< 16; i++ ){
//			kthread_create(func, malloc(4000) ,4000);
//
//	}
//
//	kthread_exit();
...
//
////	  int l=
//			  kthread_join(kthread_id()+1);
//	  	//	printf(1,"thread %d joint with %d with resault %d\n " ,kthread_id(),kthread_id()+1,l );
//	kthread_exit();
//}
//
//
