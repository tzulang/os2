...
00003f7d <kthread_mutex_dealloc>:
SYSCALL(kthread_mutex_dealloc)
    3f7d:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3f82:	cd 40                	int    $0x40
    3f84:	c3                   	ret    

00003f85 <kthread_mutex_lock>:
SYSCALL(kthread_mutex_lock)
    3f85:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3f8a:	cd 40                	int    $0x40
    3f8c:	c3                   	ret    

00003f8d <kthread_mutex_unlock>:
SYSCALL(kthread_mutex_unlock)
    3f8d:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3f92:	cd 40                	int    $0x40
    3f94:	c3                   	ret    

00003f95 <kthread_mutex_yieldlock>:
